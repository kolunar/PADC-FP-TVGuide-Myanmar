...
public class ChannelDetailAdapter extends RecyclerView.Adapter<ChannelProgramViewHolder> {
    ...
    public void setNewData(List<ChannelProgramVO> newChannelProgramList, Boolean isNetwork, Boolean isPersistence) {
        if(isNetwork){
            Log.e(MMChannelsApp.TAG, "ChannelDetailAdapter.setNewData(isNetwork).newChannelProgramList.size(): " + newChannelProgramList.size());
        }
        else if(isPersistence){
            Log.e(MMChannelsApp.TAG, "ChannelDetailAdapter.setNewData(isPersistence).newChannelProgramList.size(): " + newChannelProgramList.size());
        }
