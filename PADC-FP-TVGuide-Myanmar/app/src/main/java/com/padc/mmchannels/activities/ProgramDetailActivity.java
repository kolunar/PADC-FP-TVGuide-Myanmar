...
public class ProgramDetailActivity extends BaseActivity implements TimePrefixDialog.AddRemoveAlarmDelegate {
    ...
    public static Intent newIntent(ProgramVO program){
        Intent intent = new Intent(MMChannelsApp.getContext(),ProgramDetailActivity.class);
        if(program != null){
            mProgramVO = program;
    ...
    public static Intent newIntent(ChannelProgramVO channelProgram){
        ...
        if(channelProgram != null){
            ...
            Toast.makeText(MMChannelsApp.getContext(), "ProgramDetailActivity.newIntent.ChannelProgramVO IS NULL", Toast.LENGTH_SHORT).show();
        }
        return intent;
    }
...
//                Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG).setAction("Action", null).show();
        ...
        if (savedInstanceState == null) {
            Log.e(MMChannelsApp.TAG, "ProgramDetailActivity:onCreate():savedInstanceState == null : isChannelProgram:" + isChannelProgram);
...
//				.diskCacheStrategy(DiskCacheStrategy.SOURCE)
    ...
    public void onEventMainThread(DataEvent.ProgramDetailsLoadedEvent event) {
        Log.e(MMChannelsApp.TAG, "ProgramDetailActivity.onEventMainThread().ProgramDetailsLoadedEvent.isChannelProgram: " + isChannelProgram);
//        String extra = event.getExtraMessage();
        ...
        if(isChannelProgram) {
            ...
            Log.e(MMChannelsApp.TAG, "ProgramDetailActivity.bindChannelProgramData() via ProgramDetailsLoadedEvent");
            if(demo != null) {
            ...
            if(mProgramVO != null) {
                ...
                Log.e(MMChannelsApp.TAG, "ProgramDetailActivity.bindProgramData() via ProgramDetailsLoadedEvent");
                bindProgramData(mProgramVO, false);
            }
        }
