...
public class ChannelDetailsVO {
    ...
    public List<ChannelProgramVO> getChannelProgramsByAirDay(String air_day, Boolean fromNetworkLayer){
        ...
        if(channel_programs != null) {
            ...
            Log.e(MMChannelsApp.TAG, "ChannelDetailsVO.getChannelProgramsByAirDay.size : " + channelProgramVOList.size() + " : " + air_day);
        }
        if(fromNetworkLayer && air_day.equalsIgnoreCase("Sat")){
            Log.e(MMChannelsApp.TAG, "ChannelDetailsVO.getChannelProgramsByAirDay().channelProgramVOList.size(): " + channelProgramVOList.size());
        }
