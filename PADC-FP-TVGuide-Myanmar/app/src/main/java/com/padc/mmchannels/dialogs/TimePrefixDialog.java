package com.padc.mmchannels.dialogs;
...
import com.padc.mmchannels.receivers.system.AlarmReceiver;
...
/*        builder.setOnKeyListener(new Dialog.OnKeyListener() {
    ...
    public static void AddAlarm(int requestCode, String air_date, String start_time, int time_ahead, boolean isCancel) {
        Intent intent = new Intent(MMChannelsApp.getContext(), AlarmReceiver.class);
        intent.putExtra("ALARM_REQUEST_CODE", requestCode);
        PendingIntent operation = PendingIntent.getBroadcast(MMChannelsApp.getContext(), requestCode, intent,  PendingIntent.FLAG_ONE_SHOT );
        AlarmManager alarm = (AlarmManager) MMChannelsApp.getContext().getSystemService(ALARM_SERVICE);
        Toast.makeText(MMChannelsApp.getContext(), "Alarm Set", Toast.LENGTH_SHORT).show();
