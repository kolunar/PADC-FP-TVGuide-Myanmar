 ...
 */
public class MyWatchListAdapter extends RecyclerView.Adapter<ProgramViewHolder> {

    private LayoutInflater inflater;
    private List<ProgramVO> mProgramList;
    private ProgramViewHolder.ControllerProgramItem mControllerProgramItem;

    public MyWatchListAdapter(List<ProgramVO> programList, ProgramViewHolder.ControllerProgramItem controllerProgramItem) {
